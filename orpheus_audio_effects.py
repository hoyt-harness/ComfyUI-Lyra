...
class OrpheusAudioEffects:
    ...
    def INPUT_TYPES(cls):
        ...
        return {
            ...
            "optional": {
                ...
                "use_limiter": (
                    "BOOLEAN",
                    {"default": True, "label": "Use Limiter for Gain"},
                ),
                "normalize_audio": (
                    "BOOLEAN",
                    {"default": False, "label": "Normalize Audio"},
                ),
    ...
    def process_audio(
        ...
        try:
            ...
            if add_reverb:
                print(
                    f"- Reverb: amount={reverb_amount}, room_scale={reverb_room_scale}"
                )
            if add_echo:
            ...
            try:
                ...
                if add_reverb:
                    ...
                    print(
                        f"Added reverb effect: {reverberance}% reverberance, {room_scale}% room scale"
                    )
                ...
                if add_echo:
                    ...
                    effects.extend(
                        ["echo", str(gain_in), str(gain_out), str(delay_ms), str(decay)]
                    )
...
# Register nodes
NODE_CLASS_MAPPINGS = {"OrpheusAudioEffects": OrpheusAudioEffects}

NODE_DISPLAY_NAME_MAPPINGS = {"OrpheusAudioEffects": "Orpheus Audio Effects"}
